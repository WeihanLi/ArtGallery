<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ContentEdit.aspx.cs" Inherits="WebApplication1.Admin.ContentEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="addcontent">
        <input type="hidden" name="itemId" runat="server" id="itemId" value=" " />
            ...
            <div class="addcolumn_button">
                <div class="addcolumn_but"><a href="javascript:void(0)" onclick="Update()"><img src="/images/cms_add.jpg" /></a></div>
                <div class="addcolumn_but"><a href="default.aspx"><img src="/images/cms_cancel.jpg" /></a></div>
            </div>
        </div>

    <script type="text/javascript">
        var itemId = $("#<%= itemId.ClientID %>").val();
        InitNewsContent(itemId);
        function Update() {
            ...
            //alert(title+content+type+imgPath);
            UpdateNews(itemId, name,desc,author, type, imgPath);
        }
    </script>
</asp:Content>
