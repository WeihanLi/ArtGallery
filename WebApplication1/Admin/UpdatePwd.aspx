<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="UpdatePwd.aspx.cs" Inherits="WebApplication1.Admin.UpdatePwd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        function ValidOldPwd(pwd) {
            $.post("LoginHandler.ashx", { "username": <%= ((Model.User)Session["User"]).UserName %>,"password":pwd,"action":"updatePwd" }, function (data) {
                if (data == "true") {
                    $("#tip").text("");
                    return true;
                } else {
